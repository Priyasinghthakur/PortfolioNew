...
import Codemithra from "./Descriptions/TrouveTavoie";
...
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Codemithra");
  return (
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Codemithra"
            BarPosition={-8}
            BarAvobePosition={1}
            DescriptionJob="Codemithra"
