...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
        ...
        >
          I&apos;m a <span className="text-AAsecondary">frontend developer</span> who tackles real-world challenges using Java.
          <br className="md:block hidden" /> With a focus on practical problem-solving. Currently.{" "}
          <br className="md:block hidden" /> I&apos;m focused on creating and Working on <span className="text-AAsecondary">projects</span> on the
          Frontend Projects.
        </motion.h3>
        <motion.div
          initial={{ y: 10, opacity: 0 }}
          ...
          className="mt-12"
        >
          <a href={"https://drive.google.com/file/d/1pyomtiBjMfEOGQrYwypjyB4PidLpqaeg/view?usp=sharing"} target={"_blank"} rel="noreferrer">
